      ...
      -->
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="h-16 flex items-center">
                      ...
                      Leaving: "transition ease-in duration-150"
                        ...
                        To: "opacity-0"
                    -->
                                    <div class="absolute top-full inset-x-0 bg-white text-sm text-gray-500 hidden">
        ...
        <main>
            ...
            <section aria-labelledby="category-heading" class="bg-gray-50">
                <div class="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                    <div class="sm:flex sm:items-baseline sm:justify-between">
                        <h2 id="category-heading" class="text-2xl font-extrabold tracking-tight text-gray-900">Featured Projects</h2>
                        <a href="#" class="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">Browse all Projects<span aria-hidden="true"> &rarr;</span></a>
                    </div>
            ...
            <section aria-labelledby="cause-heading">
                <div class="relative bg-gray-800 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
                    ...
                    <div class="relative max-w-3xl mx-auto flex flex-col items-center text-center">
                        <h2 id="cause-heading" class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">Follow Ava's Subnet Journey</h2>
                        <p class="mt-3 text-xl text-white">
                            We're committed to responsible, sustainable, and ethical manufacturing. Our small-scale approach allows us to focus on quality and reduce our impact. We're doing our best to delay the inevitable heat-death of the
                            universe.
                        </p>
            ...
            <section aria-labelledby="favorites-heading">
                <div class="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                    <div class="sm:flex sm:items-baseline sm:justify-between">
                        <h2 id="favorites-heading" class="text-2xl font-extrabold tracking-tight text-gray-900">Featured Validators</h2>
                        <a href="#" class="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">Browse all Validators<span aria-hidden="true"> &rarr;</span></a>
                    </div>
