...
const styles = {
    ...
    success: {
        container: 'bg-purple-50 dark:bg-slate-800/60 dark:ring-1 dark:ring-slate-300/10',
        title: 'text-purple-900 dark:text-purple-500',
        body: 'text-purple-800 prose-code:text-purple-900 prose-a:text-purple-900 [--tw-prose-underline:theme(colors.purple.400)] dark:[--tw-prose-underline:theme(colors.sky.700)] [--tw-prose-background:theme(colors.purple.50)] dark:text-slate-300 dark:prose-code:text-slate-300',
    },
    warning: {
...
const icons = {
    ...
    success: (props) => <Icon icon="installation" {...props} />,
