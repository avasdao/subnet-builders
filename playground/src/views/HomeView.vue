            ...
            -->
                    ...
                    <nav class="mt-5 flex-shrink-0 h-full divide-y divide-cyan-800 overflow-y-auto" aria-label="SideBar">
                        <div class="px-2 space-y-1">
                            ...
                            <a href="javascript://" class="bg-cyan-800 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md" aria-current="page">
                            ...
                            <a href="javascript://" class="text-cyan-100 hover:text-white hover:bg-cyan-600 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                        ...
                        <div class="mt-6 pt-6">
                            <div class="px-2 space-y-1">
                                <a href="javascript://" class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-cyan-100 hover:text-white hover:bg-cyan-600">
            ...
            <div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none">
                ...
                -->
                            ...
                            >
                                ...
                                <a href="javascript://" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <main class="flex-1 pb-8 bg-yellow-500 rounded-xl border-4 mt-2 mr-2 p-2 border-yellow-700">
                <!-- Page header -->
                        ...
                        <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div class="bg-white overflow-hidden shadow rounded-lg">
                                ...
                                <div class="bg-gray-50 px-5 py-3">
                                    <div class="text-sm">
                                        <a href="javascript://" class="font-medium text-cyan-700 hover:text-cyan-900"> View all </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="shadow sm:hidden">
                        ...
                        <nav class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200" aria-label="Pagination">
                            <div class="flex-1 flex justify-between">
                                <a href="javascript://" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:text-gray-500"> Previous </a>
                                <a href="javascript://" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:text-gray-500"> Next </a>
                            </div>
                        </nav>
                    </div>
                                ...
                                <div class="align-middle min-w-full overflow-x-auto shadow overflow-hidden sm:rounded-lg">
                                    ...
                                    <nav class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6" aria-label="Pagination">
                                        ...
                                        <div class="flex-1 flex justify-between sm:justify-end">
                                            <a href="javascript://" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"> Previous </a>
                                            <a href="javascript://" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"> Next </a>
                                        </div>
                                    </nav>
                                </div>
                            </div>
